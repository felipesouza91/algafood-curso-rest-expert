...
import com.felipe.algafood.api.docs.RestauranteFotoProdutoControllerOpenApi;
...
@RestController
@RequestMapping(path ="/restaurantes/{restId}/produtos/{prodId}/foto", produces = MediaType.APPLICATION_JSON_VALUE)
